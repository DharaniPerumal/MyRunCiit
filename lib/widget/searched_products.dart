...
import 'package:myrunciit/widget/search_grid.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: <Widget>[Text("Search Result",style: TextStyle(color: Colors.white,fontSize: 18.0,fontWeight: FontWeight.bold),)],
          ...
          Column(
            ...
            children: [
              ...
              Container(
                  ...
                  width: size.width,
                  color: Colors.white,
                  child: SearchGrid(product1: widget.product)),
            ],
          ),
        ],
      ),
