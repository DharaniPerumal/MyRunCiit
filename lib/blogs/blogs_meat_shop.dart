...
class BlogsMeatShop extends StatefulWidget {
  @override
  State<BlogsMeatShop> createState() => _BlogsMeatShopState();
}

class _BlogsMeatShopState extends State<BlogsMeatShop> {
  bool all_blogs = true;
  @override
  void initState() {
    super.initState();
  ...
  getblogdetails() async {
    ...
    setState(() {
      link_blog2 = prefs.getString('bloglink');
    });

    print("link_blog$link_blog2");
  }
  ...
  get_blogs_api() async {
    ...
    if (status == "SUCCESS") {
      setState(() {
        blogs2 = jsonResponse["response"];
      });

      print('status123_blogs${blogs2}');
        ...
        child: SingleChildScrollView(
          ...
          child: Container(
            ...
            child: ListView.builder(
              ...
              itemCount:  blogs2?.length ?? 0,
              itemBuilder: (context, index) {
                if (blogs2 != null && blogs2.isNotEmpty && blogs2[index] != null) {
                  String summary1 = blogs2 != null && blogs2[index] != null
                      ? blogs2[index]['summery']
                      : '';

                  String summary = Bidi.stripHtmlIfNeeded(summary1);
                  if (blogs2[index]['blog_category_name'] == "Meat shop") {
                    return Padding(
