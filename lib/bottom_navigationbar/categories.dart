...
import 'package:myrunciit/widget/gridview_2.dart';
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: <Widget>[Text("All Categories",style: TextStyle(color: Colors.white, fontSize: 18.0, fontWeight: FontWeight.bold)),],
          ),
