...
class _FeaturedProductsState extends State<FeaturedProducts> {
  ...
  getstoreid() async {
    ...
    setState(() {
      ...
      featured_products = prefs.getBool('Featured')!;
...
class advfeatured extends StatefulWidget {
  const advfeatured({super.key});

  @override
  State<advfeatured> createState() => _advfeaturedState();
}

class _advfeaturedState extends State<advfeatured> {
  ...
  getrencent() async {
    String url1 = "$root_web/getFeatured/2";
    ...
    if (response.statusCode == 200) {
      ...
      if (jsonResponse != null &&
          ...
          jsonResponse['Response']["featuredProducts"] != null) {
        setState(() {
          // Access the array of categories from the response
          recent = jsonResponse['Response']["featuredProducts"];
