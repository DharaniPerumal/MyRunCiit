...
class _TodayDealsState extends State<TodayDeals> {
  ...
  getstoreid() async {
    ...
    setState(() {
      ...
      todaysdeals = prefs.getBool('toadys_deals')!;
      print("todaysdeals$todaysdeals");
    });
...
class adv1 extends StatefulWidget {
  @override
  _adv1State createState() => _adv1State();
}

class _adv1State extends State<adv1> {
  StreamController<List> _dealsStreamController = StreamController<List>();
  ...
  gettoadydeals() async {
    String url1 = "$root_web/getLatestProducts/2";
                          ...
                          children: [
                            Container(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  if (int.tryParse(todaydeals[index]["discount"]) !=
                                      null &&
                                      int.parse(todaydeals[index]["discount"]) > 0)
                                    Padding(
                                      padding:
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Container(
                                          height: 80,
                                          width: 100,
                                          child: todaydeals[index]["banner"] != null
                                              ? Image.network(
