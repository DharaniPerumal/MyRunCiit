...
var store_id;
var all_price = [];
class Todaysdealsgrid extends StatefulWidget {
  @override
  _TodaysdealsgridState createState() => _TodaysdealsgridState();
}

class _TodaysdealsgridState extends State<Todaysdealsgrid> {
  ...
  gettoadydeals() async {
    // SharedPreferences prefs = await SharedPreferences.getInstance();
    //   store_id = prefs.getString('storeid') == null ? 2 : prefs.getString('storeid');
    ...
    if (response.statusCode == 200) {
      ...
      if (jsonResponse != null &&
        ...
        setState(() {
          ...
          setState(() {
            for (var k = 0; k < todaydeals.length; k++) {
              // all_data.add(recommended_response["Response"][k]);
              var ob_data = jsonDecode(todaydeals[k]["multiple_price"]);
              if(ob_data.length != 0){
                var low = 0;
              ...
              {
                setState(() {
                  all_price.add(todaydeals[k]["sale_price"].toString());
                });
              }
